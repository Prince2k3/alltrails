...
class UpdateLocationAndSearchNearbyRestaurantsUseCaseTests: XCTestCase {
    ...
    func test_useCase_withLocationGetNearbyRestaurants() {
        ...
        let sut = UpdateLocationAndSearchNearbyRestaurantsUseCase(
        ...
        let cancellable = sut.searchRestaurants(searchText).sinkValue { restaurants in
